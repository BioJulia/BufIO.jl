...
"""
Base.filesize(x::VecWriter) = length(get_memory(x.vec))

# TODO: An inconsistency with seek and filesize.
# Suppose I write 10 bytes, then seek to position 5.
# What's the filesize? 10 or 5?
